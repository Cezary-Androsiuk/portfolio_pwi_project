<?php
    ...
    if(isset($_POST['content'])){
        $update_content_query = $database->prepare('UPDATE education SET content = :c WHERE data_id = 1;');
...
<html>
    ...
    <body>
        ...
        <main class="content">
            <?php
                $select_content_query =$database->prepare('SELECT content FROM education;');
                ...
                echo '
                <br/>
                <form method="post" action="l_education.php">
